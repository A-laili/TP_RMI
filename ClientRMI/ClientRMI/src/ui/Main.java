...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SearchMenuItem.setText("Rechercher les Machines / salle");
    ...
    private void machineMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_machineMenuItemActionPerformed
       ...
       MachineForm mf = MachineForm.getInstance();
        ...
        if (mf == null || !mf.isVisible()) {
            ...
            JOptionPane.showMessageDialog(this, "Une fenetre de gestion des machines est déjà ouverte");
        }
    ...
    private void salleMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salleMenuItemActionPerformed
        ...
        if (sf == null || !sf.isVisible()) {
            ...
            JOptionPane.showMessageDialog(this, "Une fenetre de gestion des salles est déjà ouverte");
        }
    }//GEN-LAST:event_salleMenuItemActionPerformed

    private void SearchMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchMenuItemActionPerformed
        // TODO add your handling code here:
        SearchForm rf = SearchForm.getInstance();
        if (rf == null || !rf.isVisible()) {
            rf = SearchForm.getInstance();
            desktopPane.add(rf);
            rf.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Une fenetre de recherche est déjà ouverte");
        }
